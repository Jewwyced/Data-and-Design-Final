...
# About
The hardest part about this project was to commit to one model and idea. At first I wanted to do a more ui/ux model, something that can take a basic description and from there recommend a color palette, font style and CSS. I tried to pursue this idea with a model from hugging face but quickly learned that the model wasn’t strong enough. The responses were basic and not interesting enough, which led me to my second and final design.
